...
app.get('/add-caller', function (req, res) {
  console.log("adding", callerNumbers)
  if (callerNumbers > 5)
  ...
  console.log("added", callerNumbers)
})

app.get('/remove-caller', function (req, res) {
  console.log("removing", callerNumbers)
  callerNumbers--
  res.send({status: "ok", callerNumbers: callerNumbers})
  console.log("removed", callerNumbers)
})
